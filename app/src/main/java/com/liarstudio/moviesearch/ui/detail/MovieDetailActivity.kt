...
class MovieDetailActivity : AppCompatActivity(), MovieDetailView {
    ...
    override fun showSame(movies: List<Movie>) {
        movie_same_name_1.text = movies.getOrNull(0)?.title
        movie_same_name_2.text = movies.getOrNull(1)?.title
        movie_same_name_3.text = movies.getOrNull(2)?.title
    }
