...
interface MovieApi {
     ...
     */
    @GET("discover/movie")
    fun discover(@Query("api_key") key: String, @Query("language") language: String): Call<MovieListResponse>
     ...
     */
    @GET("search/movie")
    fun search(@Query("api_key") key: String, @Query("language") language: String, @Query("query") query: String): Call<MovieListResponse>
